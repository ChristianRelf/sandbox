...
- Publication still requires the protected GitHub release environment and an immutable `v0.7.2-beta.4` tag. A valid Windows signing certificate remains mandatory for stable releases, but not this invite-only prerelease.
