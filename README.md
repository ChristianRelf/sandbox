...
- Publication still requires the protected GitHub release environment and an immutable `v0.8.0-beta.1` tag. A valid Windows signing certificate remains mandatory for stable releases, but not this invite-only prerelease.
