...
describe("control-plane API", () => {
  ...
  it("starts and reads a versioned run through the public API",async()=>{
    ...
    const requirements={protocolVersion:2 as const,engineVersion:"0.7.2-beta.2",pluginRuntimeVersion:"0.7.2-beta.2",runnerTypes:["hosted" as const],architectures:["x86_64" as const],workspaceId,environmentId,region:"eu-west-2",requiredTags:[],capabilities:[],plugins:[],connectionIds:[],minimumAvailableConcurrency:1};
