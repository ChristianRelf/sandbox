...
describe("browser workload lifecycle",()=>{
  ...
  const execution=(id:string,steps:BrowserExecution["steps"]):BrowserExecution=>({executionId:id,workspaceId:"20000000-0000-4000-8000-000000000002",environmentId:"30000000-0000-4000-8000-000000000003",deploymentId:"40000000-0000-4000-8000-000000000004",region:"eu-west-2",profile:null,steps,maximumArtifactBytes:1024*1024,allowedUploadRoots:[]});
