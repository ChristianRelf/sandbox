...
For the first deployment, open **Actions > Deploy DigitalOcean beta > Run workflow**, enter the published version without `v` (for example `0.7.0-beta.2`), and select `website`.
...
```bash
./deploy.sh 0.7.0-beta.2 website
```
