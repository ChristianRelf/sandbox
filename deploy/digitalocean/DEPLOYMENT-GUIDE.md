...
## 10. Publish `v0.7.0-beta.1`

Before tagging, ensure all deployment changes are committed and pushed, the working tree is clean, and these files all contain version `0.7.0-beta.1`:
...
git status --short
git tag -a v0.7.0-beta.1 -m "Sandbox v0.7.0 beta 1"
...
| --- | --- |
| Branch | `main` |
| Version | `0.7.0-beta.1` — do not include `v` |
| Deployment | `website` |
...
The Git tag, root package version, and Tauri version must match exactly. Supported prerelease tags use forms such as `v0.7.0-beta.1`, not `v0.7-beta` or `v0.7.0-beta1`.
