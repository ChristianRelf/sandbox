      ...
      <div className="doc-column">
        ...
        <article className="doc-article">
          ...
          {page.prerequisites && <section id="prerequisites" className="prerequisites">
            <div className="section-heading"><small>Before you begin</small><h2>Prerequisites</h2></div>
            <ul>{page.prerequisites.map(value => <li key={value}><CheckCircle2 size={13}/>{value}</li>)}</ul>
          </section>}

          {page.concepts && <section id="key-concepts">
            <div className="section-heading"><small>Mental model</small><h2>Key concepts</h2></div>
          ...
          <section id="procedure">
            <div className="section-heading"><small>Procedure</small><h2>How it works</h2></div>
          ...
          <section id="troubleshooting">
            <div className="section-heading"><small>If something fails</small><h2>Common errors</h2></div>
          ...
          <section id="related-pages">
            <div className="section-heading"><small>Keep reading</small><h2>Related pages</h2></div>
