...
<CardGroup cols={2}>
  ...
  <Card title="Draft with AI" icon="sparkles" href="/workflows/ai-builder">
    Connect a model, propose a graph, or write complete Code node files.
  </Card>
  <Card title="Build a localhost site" icon="file-code-2" href="/files-and-data/code-and-web-builder">
    Map HTML, JavaScript, and CSS Code outputs into Web Builder.
  </Card>
</CardGroup>
